...
def getWordScore(word, n):
    ...
    #Iterating through word to tally character scores
    try:
        for c in word.lower():
            score += SCRABBLE_LETTER_VALUES[c]
#            print (c, SCRABBLE_LETTER_VALUES[c], score)
    
    except KeyError:
        raise KeyError("non-alphabet character detected")
...
#        print (score)
        ...
        if score < 0:
            raise Exception("Score is negative")
        else:
            return score
...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        ...
        for element in wordFreq:
            if not(element in hand):
                return False
            elif hand[element] < wordFreq[element]:
                return False
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                points += wordPoints
                print ("\"" + str(word) + "\" earned " + str(wordPoints) + " points. Total: " + str(points) + " points")
                print("")
                # Update the hand
